...
public class AlojamientoRepository implements AlojamientoDataSource {
    ...
    public static final List<Alojamiento> _ALOJAMIENTOS = List.of(
            new Departamento(UUID.randomUUID(), 1, "Dpto1", "El primer dpto",2, 120000.0,true, 300d,1, AlojamientoRepository._UBICACIONES.get(0), "https://imgar.zonapropcdn.com/avisos/1/00/47/80/48/58/720x532/1765004636.jpg"),
            new Departamento(UUID.randomUUID(),2, "Dpto2", "El segundo dpto",1, 25000.0,false, 100d,1, AlojamientoRepository._UBICACIONES.get(0), "https://cf.bstatic.com/xdata/images/hotel/max1024x768/242172610.jpg?k=7a80e01d5d1f41c65c05f3b36705dccdb97d26dc47417d5b5440ea3217925001&o=&hp=1"),
            new Departamento(UUID.randomUUID(), 3, "Dpto3", "El tercer dpto",10, 290000.0,true, 600d,5, AlojamientoRepository._UBICACIONES.get(0),"https://cf.bstatic.com/xdata/images/hotel/270x200/283211646.jpg?k=b5f5623d636426ad7579429591fad7fab0d174bb428d4b409ff2606bc3c7c5f3&o="),
            new Habitacion(UUID.randomUUID(),1,"habitacion1","una habitacion",1,3000d,1,0,false, AlojamientoRepository._HOTELES.get(0), "https://media-cdn.tripadvisor.com/media/photo-s/0f/03/33/f1/habitacion-individual.jpg"),
            new Habitacion(UUID.randomUUID(),2,"habitacion2","otra habitacion",3,12500d,1,1,false, AlojamientoRepository._HOTELES.get(0), "https://media-cdn.tripadvisor.com/media/photo-s/0f/52/9e/83/habitacion-estudio-cama.jpg")

    );

    public static final List<Departamento> _DEPARTAMENTOS = List.of(
            (Departamento) AlojamientoRepository._ALOJAMIENTOS.get(0),
            (Departamento) AlojamientoRepository._ALOJAMIENTOS.get(1),
            (Departamento) AlojamientoRepository._ALOJAMIENTOS.get(2)

            //new Departamento(AlojamientoRepository._ALOJAMIENTOS.get(0).getId(),1, "Dpto1", "El primer dpto",2, 120000.0,true, 300d,1, AlojamientoRepository._UBICACIONES.get(0), "https://imgar.zonapropcdn.com/avisos/1/00/47/80/48/58/720x532/1765004636.jpg")
    ...
    public static final List<Habitacion> _HABITACIONES = List.of(
            (Habitacion)AlojamientoRepository._ALOJAMIENTOS.get(3),
            (Habitacion)AlojamientoRepository._ALOJAMIENTOS.get(4)
